...
'    'Public Shared Function GenereFacture(ByVal pdInventaire As Date, ByVal pdfin As Date, ByVal pFourn As Fournisseur) As FactColisageJ
...
'    '            oProduit.load(oRow.PRD)

'    '            oFactCol.AjouteLigne("", getDateDebutdeMois(oRow.RC_DATE), getDateFindeMois(oRow.RC_DATE), oRow.RC_SI, oRow.RC_ENTREE, oRow.RC_SORTIE, oRow.RC_SF)
'    '        End If
'    '    Next
'    '    Return oFactCol
