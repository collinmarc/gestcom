...
<System.Runtime.InteropServices.ProgId("colItem_NET.colItem")> Public Class colItem
	...
	Friend Function Add(ByVal strName As String, ByVal lngAttributes As Integer) As clsItem
		
		Dim objNewItem As clsItem
		
		'instantiate a new item
		objNewItem = New clsItem
	...
	Friend ReadOnly Property Item(ByVal vntItem As Object) As clsItem
		Get
