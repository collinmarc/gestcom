...
Public Class clsFTP
    ...
    Private mcolItemList As colItem
    ...
    Private Const DEFAULT_TRANSFER_TYPE As Integer = FTP_TRANSFER_TYPE_ASCII
    ...
    Public Function bQGetFile(ByVal strServerName As String, ByVal strUserID As String, ByVal strPassword As String, ByVal strSourceFile As String, ByVal strTargetFile As String, ByVal lngTransferType As Integer, ByVal blnOverWrite As Boolean) As Object
    ...
    Public Function bQPutFile(ByVal strServerName As String, ByVal strUserID As String, ByVal strPassword As String, ByVal strSourceFile As String, ByVal strTargetFile As String, ByVal lngTransferType As Integer) As Object
    ...
    Public Function sGetDirName(ByVal intItem As Short) As Object
    ...
    Public Function lGetDirCount() As Object
    ...
    Public Function bGetDir(Optional ByVal strDir As String = "", Optional ByVal intType As Short = 0) As Object
    ...
    Public Function sListDir(Optional ByVal strDir As String = "", Optional ByVal intType As Short = 0) As Object
    ...
    Protected Overrides Sub Finalize()
        ...
        MyBase.Finalize()
    End Sub
    Public Function bDisconnect() As Object
    ...
    Public Property lFileAccess() As Object
        Get
    ...
    Public Property lAccessType() As Object
        Get
    ...
    Public Property sProxyName() As Object
        Get
    ...
    Public Property sProxyBypass() As Object
        Get
            'UPGRADE_WARNING: Impossible de résoudre la propriété par défaut de l'objet sProxyBypass. Cliquez ici : 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
            sProxyBypass = mstrProxyBypass
        End Get
        Set(ByVal Value As Object)
            'UPGRADE_WARNING: Impossible de résoudre la propriété par défaut de l'objet strProxyBypass. Cliquez ici : 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
            mstrProxyBypass = Trim(Value)
        End Set
    End Property

    Public ReadOnly Property sError() As Object
        Get
    ...
    Public ReadOnly Property lErrorNum() As Object
        Get
    ...
    Public ReadOnly Property sErrorDesc() As Object
        Get
    ...
    Public Property sServerName() As Object
        Get
    ...
    Public Property sUserID() As Object
        Get
    ...
    Public Property sPassword() As Object
        Get
    ...
    Public Property bPassiveMode() As Object
        Get
    ...
    Public Property bOverWrite() As Object
        Get
    ...
    Public Property lTransferType() As Object
        Get
    ...
    Public Function bCloseFile() As Object
    ...
    Public Function sConvertCrLf(ByVal strData As String) As Object
    ...
    Public Function sReadFile() As Object
    ...
    Public Function bWriteFile(ByVal strData As String) As Object
    ...
    Public Function bOpenFile(ByVal strFileName As String) As Object

        Dim blnRC As Boolean
        Dim lConnRC As Integer
    ...
    Public Function bConnect() As Object
    ...
    Public Function bRename(ByVal strCurrentName As String, ByVal strNewName As String) As Object
    ...
    Public Function bGetFile(ByVal strSourceFile As String, ByVal strTargetFile As String) As Object
    ...
    Public Function bPutFile(ByVal strSourceFile As String, ByVal strTargetFile As String) As Object
    ...
    Public Function bQRemoveDir(ByVal strServerName As String, ByVal strUserID As String, ByVal strPassword As String, ByVal strDir As String) As Object
    ...
    Public Function bQMakeDir(ByVal strServerName As String, ByVal strUserID As String, ByVal strPassword As String, ByVal strDir As String) As Object
    ...
    Public Function bQRename(ByVal strServerName As String, ByVal strUserID As String, ByVal strPassword As String, ByVal strCurrentName As String, ByVal strNewName As String) As Object
    ...
    Public Function bQDeleteFile(ByVal strServerName As String, ByVal strUserID As String, ByVal strPassword As String, ByVal strFile As String) As Object
    ...
    Public Function bRemoveDir(ByVal strDir As String) As Object
    ...
    Public Function bMakeDir(ByVal strDir As String) As Object
    ...
    Public Function bDeleteFile(ByVal strFile As String) As Object
    ...
    Public Function bSetCurrentDir(ByVal strDirName As String) As Object
    ...
    End Sub
    Public Function sGetCurrentDir() As Object
