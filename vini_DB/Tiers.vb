...
Public Class Tiers
    ...
    Private m_IDPrestashop As Integer    'Id du mode de reglement Facture 3
    ...
    Friend Overridable Function loadLight() As Boolean
        Return False
    End Function
