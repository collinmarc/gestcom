...
'===================================================================================================================================
' Classe : EtatMvtFact
' Description : Mouvement de stock facturé
'===================================================================================================================================
'Membres de Classes
'==================
'Public
...
'
'===================================================================================================================================
Public Class EtatMvtStock_Fact
...
#Region "Accesseurs"
    ...
    Public Sub New()
        MyBase.New()
        codeEtat = vncEnums.vncEtatMVTSTK.vncMVTSTK_Fact
        m_libelle = ETAT_MVTSTK_FACTURE
    End Sub
...
#End Region
    ...
    Protected Overrides Function action(ByVal vncAction As vncActionFactColisage) As vncEtatMVTSTK
        ...
        Select Case vncAction
            Case vncEnums.vncActionFactColisage.vncActionAnnFacturer
                nReturn = vncEnums.vncEtatMVTSTK.vncMVTSTK_nFact
            Case Else
                nReturn = m_codeEtat
        End Select
        Return nReturn
