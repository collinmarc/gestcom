...
Public Class crListeFactCom
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crListeFactCom.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrListeFactCom
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crListeFactCom = New crListeFactCom()
        rpt.Site = Me.Site
        Return rpt
    End Function
