...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Ce programme va supprimer les mouvements de stocks antérieurs à la date que vous " & _
        "allez fournir.  Normalement ceci se fait après une saisie d'inventaire complête." & _
        ""
        '
        'Label3
        '
        ...
        Me.Label4.Text = "Purger les mouvements de stocks antérieurs à "
        '
        'cbValider
        '
...
#End Region
    ...
    Private Sub cbValider_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbValider.Click
        If MsgBox("Etes-vous sur de vouloir purger les mouvements de stocks antérieurs au " & dtDatePurge.Value.ToShortDateString, MsgBoxStyle.OkCancel, "Purge des Mouvements de Stocks") = MsgBoxResult.Ok Then
