...
Public Class crRecapColisageJournalier
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crRecapColisageJournalier.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crRecapColisageJournalier.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NbJour() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrRecapColisageJournalier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRecapColisageJournalier = New crRecapColisageJournalier()
        rpt.Site = Me.Site
        Return rpt
    End Function
