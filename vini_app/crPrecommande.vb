...
Public Class crPrecommande
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crPrecommande.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPrecommande
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPrecommande = New crPrecommande()
        rpt.Site = Me.Site
        Return rpt
    End Function
