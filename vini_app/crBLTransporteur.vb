...
Public Class crBLTransporteur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crBLTransporteur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBLTransporteur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBLTransporteur = New crBLTransporteur()
        rpt.Site = Me.Site
        Return rpt
    End Function
