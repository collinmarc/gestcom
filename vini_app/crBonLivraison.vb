...
Public Class crBonLivraison
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crBonLivraison.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBonLivraison
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBonLivraison = New crBonLivraison()
        rpt.Site = Me.Site
        Return rpt
    End Function
