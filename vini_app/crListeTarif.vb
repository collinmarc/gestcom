...
Public Class crListeTarif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crListeTarif.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CODETARIF() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrListeTarif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crListeTarif = New crListeTarif()
        rpt.Site = Me.Site
        Return rpt
    End Function
