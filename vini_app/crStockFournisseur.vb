...
Public Class crStockFournisseur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crStockFournisseur.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDFournisseur() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrStockFournisseur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crStockFournisseur = New crStockFournisseur()
        rpt.Site = Me.Site
        Return rpt
    End Function
