...
Public Class crMouvementArticle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crMouvementArticle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMouvementArticle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMouvementArticle = New crMouvementArticle()
        rpt.Site = Me.Site
        Return rpt
    End Function
