...
Public Class crFactHobivin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crFactHobivin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFactHobivin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFactHobivin = New crFactHobivin()
        rpt.Site = Me.Site
        Return rpt
    End Function
