...
Public Class crLstCommandes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crLstCommandes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLstCommandes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLstCommandes = New crLstCommandes()
        rpt.Site = Me.Site
        Return rpt
    End Function
