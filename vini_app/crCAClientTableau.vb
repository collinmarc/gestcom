...
Public Class crCAClientTableau
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crCAClientTableau.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCAClientTableau
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCAClientTableau = New crCAClientTableau()
        rpt.Site = Me.Site
        Return rpt
    End Function
