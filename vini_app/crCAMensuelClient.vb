...
Public Class crCAMensuelClient
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crCAMensuelClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCAMensuelClient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCAMensuelClient = New crCAMensuelClient()
        rpt.Site = Me.Site
        Return rpt
    End Function
