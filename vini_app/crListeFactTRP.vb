...
Public Class crListeFactTRP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crListeFactTRP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrListeFactTRP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crListeFactTRP = New crListeFactTRP()
        rpt.Site = Me.Site
        Return rpt
    End Function
