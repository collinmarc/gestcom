...
Public Class crFactCom_Releve
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crFactCom_Releve.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFactCom_Releve
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFactCom_Releve = New crFactCom_Releve()
        rpt.Site = Me.Site
        Return rpt
    End Function
