...
Public Class crDetailCommandeClient
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crDetailCommandeClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crDetailCommandeClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDCommande() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrDetailCommandeClient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetailCommandeClient = New crDetailCommandeClient()
        rpt.Site = Me.Site
        Return rpt
    End Function
