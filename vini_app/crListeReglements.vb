...
Public Class crListeReglements
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crListeReglements.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TypeFact() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrListeReglements
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crListeReglements = New crListeReglements()
        rpt.Site = Me.Site
        Return rpt
    End Function
