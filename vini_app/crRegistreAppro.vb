...
Public Class crRegistreAppro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crRegistreAppro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRegistreAppro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRegistreAppro = New crRegistreAppro()
        rpt.Site = Me.Site
        Return rpt
    End Function
