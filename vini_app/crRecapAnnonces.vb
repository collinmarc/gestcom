...
Public Class crRecapAnnonces
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crRecapAnnonces.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRecapAnnonces
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRecapAnnonces = New crRecapAnnonces()
        rpt.Site = Me.Site
        Return rpt
    End Function
