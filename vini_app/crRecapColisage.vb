...
Public Class crRecapColisage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crRecapColisage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRecapColisage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRecapColisage = New crRecapColisage()
        rpt.Site = Me.Site
        Return rpt
    End Function
