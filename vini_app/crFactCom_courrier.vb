...
Public Class crFactCom_courrier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crFactCom_courrier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFactCom_courrier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFactCom_courrier = New crFactCom_courrier()
        rpt.Site = Me.Site
        Return rpt
    End Function
