...
Public Class crListePalettes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crListePalettes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrListePalettes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crListePalettes = New crListePalettes()
        rpt.Site = Me.Site
        Return rpt
    End Function
