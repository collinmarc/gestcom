...
Public Class crBonAppro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crBonAppro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDAppro() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_crReferencesrpt_DATEREF() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrBonAppro
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBonAppro = New crBonAppro()
        rpt.Site = Me.Site
        Return rpt
    End Function
