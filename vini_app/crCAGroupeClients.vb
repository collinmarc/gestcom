...
Public Class crCAGroupeClients
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crCAGroupeClients.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCAGroupeClients
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCAGroupeClients = New crCAGroupeClients()
        rpt.Site = Me.Site
        Return rpt
    End Function
