...
Public Class crLstBonAppro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crLstBonAppro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLstBonAppro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLstBonAppro = New crLstBonAppro()
        rpt.Site = Me.Site
        Return rpt
    End Function
