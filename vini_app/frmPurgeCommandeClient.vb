...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label4.Text = "Purger les commandes clients antérieures à "
        '
        'dtDatePurge
        '
        ...
        Me.Label2.Text = "Ce programme va supprimer les commandes clients ECLATEES et FACTUREES antérieures" & _
        "  à la date que vous allez fournir. Ce programme ne supprime ni les mouvements d" & _
...
#End Region
    ...
    Private Sub cbValider_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbValider.Click
        If MsgBox("Etes-vous sur de vouloir purger les commandes clients antérieures au " & dtDatePurge.Value.ToShortDateString, MsgBoxStyle.OkCancel, "Purge des commandes clients") = MsgBoxResult.Ok Then
