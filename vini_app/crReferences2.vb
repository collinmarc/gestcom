...
Public Class crReferences2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_app.crReferences2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReferences2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReferences2 = New crReferences2()
        rpt.Site = Me.Site
        Return rpt
    End Function
