...
Public Class crBonFournisseur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vini_internet.crBonFournisseur.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDSCMD() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrBonFournisseur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBonFournisseur = New crBonFournisseur()
        rpt.Site = Me.Site
        Return rpt
    End Function
